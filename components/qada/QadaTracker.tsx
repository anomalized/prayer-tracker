  ...
  return (
    <div
      className={`rounded-3xl border p-4 transition-all duration-300
        ${done
          ? "bg-gradient-to-br from-nude-100 to-nude-200 border-nude-300"
    ...
    >
      <div className="flex items-center gap-3">
        <div
          className={`w-11 h-11 rounded-2xl flex items-center justify-center
            ...
            ${done ? "bg-gradient-to-br from-nude-300 to-nude-400" : "bg-nude-100"}`}
        >
          {done ? "✓" : meta.icon}
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-1.5">
            <p className="font-display text-base font-bold text-nude-800">{name}</p>
            <p className="font-body text-xs text-nude-400">{meta.arabic}</p>
          </div>
          <p className="font-body text-xs text-nude-400">{meta.time}</p>
        </div>
        ...
        <div className="flex flex-col items-end mr-2">
          ...
          {editing ? (
            <input
              ...
              className="w-16 text-right bg-nude-50 border border-nude-300 rounded-xl px-2 py-0.5 font-display text-xl font-bold text-nude-800 focus:outline-none focus:border-nude-400"
            />
          ) : (
            <button
              onClick={handleEditStart}
              title="Tap to edit remaining count"
              className="font-display text-2xl font-bold text-nude-800 hover:text-nude-600 transition-colors leading-none"
            >
              {remainingCount}
            </button>
          )}
        ...
        <button
          ...
          className={`w-12 h-12 rounded-2xl flex items-center justify-center text-2xl font-bold flex-shrink-0 transition-all duration-200 active:scale-90 disabled:cursor-not-allowed
            ${flash
              ...
              : remainingCount === 0
                ? "bg-nude-50 border border-nude-200 text-nude-200"
                : isPending
      ...
      {total > 0 && (
        <div className="mt-3">
          <div className="flex justify-between items-center mb-1">
            <p className="font-body text-[10px] text-nude-400">{madeUpCount} made up</p>
            <p className="font-body text-[10px] text-nude-400">{done ? "Complete 🌸" : `${progress}%`}</p>
          </div>
      ...
      {total === 0 && (
        <p className="font-body text-xs text-nude-300 mt-2 pl-1">
...
export default function QadaTracker({ initialStats }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {totalDebt > 0 ? (
        <div className="rounded-3xl border border-nude-200 p-5" style={{ background: "linear-gradient(135deg, #fdf0ea, #f5e2d8)" }}>
          <div className="flex items-end justify-between mb-3">
            <div>
              <p className="font-body text-[10px] font-bold tracking-widest text-nude-400 uppercase">
                Overall progress
              </p>
              <p className="font-display text-3xl font-bold text-nude-800 mt-0.5">
                {totalMadeUp}
                <span className="font-body text-sm text-nude-500 ml-1 font-normal">
                  / {totalDebt} made up
                </span>
              </p>
            </div>
            <div className="text-right">
              <p className="font-body text-xs text-nude-500">Remaining</p>
          ...
          <p className="font-body text-xs text-nude-500 mt-1.5 text-right">
            {overallPct}% cleared
          </p>
        </div>
      ) : (
        <div className="bg-nude-50 border border-nude-100 rounded-3xl p-5 text-center">
          <p className="text-3xl mb-2">🤲</p>
          <p className="font-display text-base font-bold text-nude-700">Track your qada prayers</p>
          <p className="font-body text-xs text-nude-400 mt-1 leading-relaxed max-w-xs mx-auto">
            Tap any number below to set how many makeup prayers you owe,
            then press <strong className="text-nude-600">+</strong> each time you complete one.
          </p>
        </div>
      )}
